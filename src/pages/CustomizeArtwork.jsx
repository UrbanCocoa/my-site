...
export default function CustomizeArtwork() {
  ...
  return (
    <div className="relative flex flex-col min-h-screen w-screen font-custom overflow-x-hidden">
      ...
      {/* Base solid background color (beneath everything) */}
      

      {/* Background Image (sits above base color) */}
      <img
        src={Bigpage}
        alt="Background"
        className="absolute inset-0 w-full h-full object-cover scale-150 z-10 opacity-10"
      />
      ...
      {/* Page Header */}
      <header className="relative z-20 flex justify-center items-center p-8 bg-accent3 shadow-lg">
        <h1 className="text-4xl font-extrabold text-accent5">Customize Your Order</h1>
      </header>

      {/* Main Order Box */}
      <main className="relative z-20 flex justify-center items-start p-10 flex-1 gap-8">
        <div className="relative z-30 w-full max-w-lg p-8 flex flex-col gap-6 rounded-xl shadow-lg bg-accent2">

          {/* Number of Projects */}
          <div className="flex flex-col gap-2">
            <label className="font-semibold">Number of Projects:</label>
            <select
              value={numProjects}
          ...
          <div className="flex flex-col gap-2">
            <label className="font-semibold">Specific Instructions:</label>
            <textarea
              value={instructions}
          ...
          <div className="flex justify-between items-center bg-accent3 p-4 rounded-lg shadow-md mt-4">
            ...
            <span className="font-semibold text-base">{currencySymbols[currency]}{price}</span>
          </div>

          {/* Add to Cart */}
          <button className="px-6 py-4 mt-4 text-lg font-bold rounded-lg shadow-md text-accent5 bg-accent3 hover:bg-darker transition">
            Add to Cart
          </button>
        </div>
      </main>
